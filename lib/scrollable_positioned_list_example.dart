...
class _ScrollablePositionedListPageState
  ...
  CustomItemScrollController itemScrollController;
  ...
  void initState() {
    ...
    itemScrollController = CustomItemScrollController(itemHeights);
    WidgetsBinding.instance.addPostFrameCallback(registerWidgetHeight);
  }

  void registerWidgetHeight(Duration d){
    final renderBox = context.findRenderObject();
    itemScrollController.registerScrollArea(renderBox.paintBounds.size, renderBox.paintBounds.top);
  }
  ...
  Widget list(Orientation orientation) {
    return DraggableScrollbar.semicircle(
      labelTextBuilder: (d) => Text("offset: ${d}"),
      alwaysVisibleScrollThumb: true,
      iController: itemScrollController,
      reversed: reversed,
            ...
            max = positions
                ...
                .reduce((ItemPosition max, ItemPosition position) =>
                    position.itemLeadingEdge > max.itemLeadingEdge
                        ...
                        : max)
                .index;
            int firstItemIndex = positions.first.index;
            double firstItemOffset = -positions.first.itemLeadingEdge;
            double firstItemRelativePos = itemScrollController.getPixelOffset(firstItemIndex);
            //print("first item offset: ${itemScrollController.scrollHeight * firstItemOffset + firstItemRelativePos}");
          }
          return Row(
            children: <Widget>[
